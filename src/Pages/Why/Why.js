...
const Why = () => {
    return (
        <div className='flex w-11/12 mx-auto mt-24 mb-24 shadow-xl sm:display:inline bg-white p-5'>
            <div>
                <p className='text-2xl text-black'>WHY CHOOSE PIP BROADCAST WEDDING PHOTOGRAPHERS IN Dhaka</p>
                <br />
